...
If you'd like to play around with just the Keras/TensorFlow model, please go to https://github.com/hatzakislab/DeepFRET-Model

## Development Repo can be found [here](https://github.com/hatzakislab/DeepFRET-GUI)
- Please use this to raise issues / feature requests.
