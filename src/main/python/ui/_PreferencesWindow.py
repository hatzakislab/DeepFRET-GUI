...
class Ui_Preferences(object):
    def setupUi(self, Preferences):
        ...
        self.checkBox_hmmLocal = QtWidgets.QCheckBox(self.hmmGroup)
        self.checkBox_hmmLocal.setObjectName("checkBox_hmmLocal")
        self.gridLayout_4.addWidget(self.checkBox_hmmLocal, 6, 0, 1, 1)
        ...
        Preferences.setTabOrder(self.checkBox_unColocRed, self.checkBox_illuCorrect)
        Preferences.setTabOrder(self.checkBox_illuCorrect, self.checkBox_fitSpots)
        Preferences.setTabOrder(self.checkBox_fitSpots, self.radioButton_dual)
        Preferences.setTabOrder(self.radioButton_dual, self.radioButton_2_col)
        Preferences.setTabOrder(self.radioButton_2_col, self.radioButton_2_col_inv)
        Preferences.setTabOrder(self.radioButton_2_col_inv, self.toleranceComboBox)
    ...
    def retranslateUi(self, Preferences):
        ...
        self.label_5.setText(
            _translate("Preferences", "      Leave off for local maxima detection")
        )
        self.label_4.setText(
            _translate(
                "Preferences", "      Disables interactivity to avoid consuming memory"
            )
        )
        ...
        self.label.setText(
            _translate("Preferences", "      For determining acceptor bleedthrough")
        )
        self.checkBox_fitSpots.setText(
            _translate(
                "Preferences", "Detect spots using Laplacian of Gaussian fitting"
            )
        )
        ...
        self.radioButton_dual.setText(
            _translate("Preferences", "Dual Cam (interleaved videos)")
        )
        ...
        self.radioButton_hmm_fitE.setText(_translate("Preferences", "E_FRET Fitting"))
        self.radioButton_hmm_fitDD.setText(_translate("Preferences", "DD/DA Fitting"))
        self.checkBox_hmmLocal.setText(
            _translate(
                "Preferences", "Idealize HMM for each trace individually (Advanced)"
            )
        )
        self.label_hmm_bic.setText(
            _translate(
                "Preferences", "BIC Strictness (raise this to detect fewer states)"
            )
        )
